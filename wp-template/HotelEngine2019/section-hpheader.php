<section id="slideshow" class="container">
      <div class="row">
        <div class="col-12 ">
          <div id="hp-section__signup" class="signup-form  d-flex align-content-center flex-wrap" style="background-image:url('<?php if ( wp_is_mobile() ) { ?><?php the_field('tablet_down_background_image'); ?><?php } else { ?><?php the_field('desktop_background_image'); ?><?php } ?>'); min-height: 810px;">
            ...
            <div class="col-xl-7 col-lg-8 ">
              <div class="signup-form__contain col-md-12">
				...
				<?php if(get_field('login_link','4')){ ?>
					<p>
					  Already a member?<br class="mobile-show" /> <a class="btn btn--inline" href="<?php the_field('signup_link', '4'); ?>" target="_blank">Log In Here</a>
					</p>
				<?php } ?>
              </div>
            </div>
