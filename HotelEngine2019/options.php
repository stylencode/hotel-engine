...
function optionsframework_options() {
	...
	$season_array = array(
		'summer' => __('Summer', 'options_check'),
		'winter' => __('Winter', 'options_check'),
		'year_round' => __('Year Round', 'options_check')
	);
	...
	$options[] = array(
		'name' => __('General Info - Address', 'options_check'),
		'desc' => __('Full Address', 'options_check'),
		'id' => 'general_address',
		'std' => '1537 East Lansing Ave<br />Denver, CO 80010',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('General Info - Phone', 'options_check'),
	...
	$options[] = array(
		'name' => __('General Info - Fax', 'options_check'),
		'desc' => __('Fax Number', 'options_check'),
		'id' => 'general_fax',
		'std' => '303-849-0293',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Twitter', 'options_check'),
		'desc' => __('Username', 'options_check'),
		'id' => 'twitter_username',
		'std' => '',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Instagram', 'options_check'),
		'desc' => __('Hashtag to Retrieve', 'options_check'),
	...
	$options[] = array(
		'name' => __('Featured Video', 'options_check'),
		'desc' => __('Embed Code', 'options_check'),
		'id' => 'featured_video',
		'type' => 'editor',
	...
	$options[] = array(
		'name' => __('Assistance Info', 'options_check'),
		'type' => 'heading');
	...
	$options[] = array(
		...
		'desc' => __('', 'options_check'),
		'id' => 'assistance_text',
		'std' => 'We have dedicated concierge staff available to help you get your experience setup and ready to go.',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Phone Number', 'options_check'),
		'desc' => __('', 'options_check'),
		'id' => 'assistance_number',
		'std' => '1 800 364 9823',
		'type' => 'text');

	$options[] = array(
		'name' => __('Suggestion Info', 'options_check'),
		'type' => 'heading');
	...
	$options[] = array(
		...
		'desc' => __('', 'options_check'),
		'id' => 'suggestion_title',
		'std' => 'Know of a great experience we should add?',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Link Text', 'options_check'),
		'desc' => __('', 'options_check'),
		'id' => 'suggestion_text',
		'std' => 'Send Us Your Suggestion',
		'type' => 'text');

	$options[] = array(
		'name' => __('Link Page', 'options_check'),
		'desc' => __('', 'options_check'),
		'id' => 'suggestion_page',
		'type' => 'select',
